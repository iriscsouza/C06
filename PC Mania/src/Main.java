...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente = new Cliente("Iris", 123456789);
            int x;
        ...
        System.out.println("Total da compra do cliente " + cliente.nome + " de cpf " + cliente.cpf + " é de: R$" +  cliente.calculaTotalCompra() );

        System.out.println("As configurações dos PCs comprados são: 1");
